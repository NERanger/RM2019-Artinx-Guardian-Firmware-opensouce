...
void chassis_behaviour_mode_set(chassis_move_t *chassis_move_mode)
{
    ...
    {
        //chassis_behaviour_mode = CHASSIS_GUARDIAN;
		chassis_behaviour_mode = CHASSIS_NO_MOVE;
		//Modified by NERanger 20190408
    }
...
// Modified by NERanger 20190409
	...
	else if (chassis_behaviour_mode == CHASSIS_GUARDIAN)
	{
		chassis_move_mode->chassis_mode = CHASSIS_VECTOR_ON_TRACK;
		//Added by NERanger 20190408
	}
	else if (chassis_behaviour_mode == CHASSIS_GUARDIAN_AUTO_PATROL)
	{
...
void chassis_behaviour_control_set(fp32 *vx_set, fp32 *vy_set, fp32 *angle_set, chassis_move_t *chassis_move_rc_to_vector)
{
	...
	else if (chassis_behaviour_mode == CHASSIS_GUARDIAN)  //Added by NERanger 20190409
    {
        chassis_open_set_control(vx_set, vy_set, angle_set, chassis_move_rc_to_vector);
    }
//	else if (chassis_behaviour_mode == CHASSIS_GUARDIAN_AUTO_PATROL)
//	{
//		*vx_set = GUARDIAN_PATROL_SPD;
//		*vy_set = 0;
//		*angle_set = 0;
//	}
}
