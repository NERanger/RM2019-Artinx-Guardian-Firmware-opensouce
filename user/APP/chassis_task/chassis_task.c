...
//		}
		...
		{
			guardian_patrol_dir = guardian_patrol_dir * (-1);
		...
		debug_chassis_move = chassis_move;
...
//	debug_vx_set = vx_set;  //Added by NERanger 20190409
	...
	else if (chassis_move_control->chassis_mode == CHASSIS_VECTOR_ON_TRACK)  //Added by NERanger 20190408
	{
		chassis_move_control->vx_set = vx_set;
	...
	else if (chassis_move_control->chassis_mode == CHASSIS_VECTOR_AUTO_PATROL)  //Added by NERanger 20190408
	{
		chassis_move_control->vx_set = (guardian_patrol_dir) * (GUARDIAN_PATROL_SPD);
		chassis_move_control->vy_set = 0;
        chassis_move_control->wz_set = 0;
        chassis_move_control->chassis_cmd_slow_set_vx.out = 0.0f;
        chassis_move_control->chassis_cmd_slow_set_vy.out = 0.0f;
...
//	if (chassis_move_control_loop->chassis_mode == CHASSIS_VECTOR_ON_TRACK)  //Added by NERanger 20190408
//	{
//		for (i = 0; i < 4; i++)
//		{
...
//		for (i = 0; i < 4; i++)
//		{
//			chassis_move_control_loop->motor_chassis[i].give_current = (int16_t)(chassis_move_control_loop->vx_set);
//		}
//		
//		return;
//	}
