...
#define MIN_YAW_RELATIVE_ANGLE_MANUAL_ADD (-1.0f)
#define MAX_PITCH_RELATIVE_ANGLE_MANUAL_SET (1.3f)
#define MIN_PITCH_RELATIVE_ANGLE_MANUAL_SET (0.2f)
//Added by NERanger 20190413

#define GIMBAL_PC_CMD_PITCH_SPEED 0.007f
#define GIMBAL_PC_CMD_YAW_SPEED   0.007f
...
#define PITCH_SPD_RC_FAC 0.00005f
//Added by NERanger 20190410

//pitch 速度环 PID参数以及 PID最大输出，积分输出
#define PITCH_SPEED_PID_KP 200.0f
...
#define PITCH_ENCODE_RELATIVE_PID_KP 100.0f
...
#define INIT_PITCH_SET 0.8f  //Modified by NERanger 20190426
